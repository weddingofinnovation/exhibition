...
<main>
        ...
        <div class="my-0">
          ...
          @elseif($board == 'event')
            ...
            <div class="tab-content pt-1">
              ...
              @elseif($currentTab === 'tab9')
              <div class="tab-pane fade show active" id="year25find" role="tabpanel">
                <div class="row mb-5 pb-2">
                  @foreach ($year26ev as $franchise)
                  <div class="container  ">
                    <div class="row text-center p-1 gx-0 mb-1  shadow-sm  border rounded border-1">
                      <div class="col  pr-0">
                        @if(Carbon\Carbon::parse ($franchise->startdate)->format('M') != Carbon\Carbon::parse ($franchise->enddate)->format('M'))
              ...
              @elseif($currentTab === 'tab10')
              <div class="tab-pane fade show active" id="year25find" role="tabpanel">
                <div class="row mb-5 pb-2">
                  @foreach ($year27ev as $franchise)
                  <div class="container  ">
                    <div class="row text-center p-1 gx-0 mb-1  shadow-sm  border rounded border-1">
                      <div class="col  pr-0">
                        @if(Carbon\Carbon::parse ($franchise->startdate)->format('M') != Carbon\Carbon::parse ($franchise->enddate)->format('M'))
          ...
          @elseif($board == 'speaker')
            ...
            test
          @elseif($board == 'exhbitor-database')
                ...
                <div class="container  ">
                  <div class="row text-center p-1 gx-0 mb-1  shadow-sm  border rounded border-1">
                    ...
                    <div class="col-7  p-0">
                      ...
                      <div class="text-muted fs-sm text-start">{{ Str::endsWith(ucwords(trans(Str::limit($franchise->s_desc, 24))), '??') 
    ? ucwords(trans(Str::limit($franchise->s_desc, 24))) 
    : ucwords(trans(Str::limit($franchise->s_desc, 24))) . ' ??' }}
</div>
                      @if($category->count() == 0)
            ...
            <div class="row text-center p-1 gx-0 mb-1  shadow-sm  border rounded border-1">
              ...
              <div class="col-7  p-0">
                ...
                <div class="text-muted fs-sm text-start">
                  ...
                  @endif
                  , {{ucfirst(trans($franchise -> city ?? 'not found'))}}
                </div>
              </div>
  ...
  <div class="d-table table-layout-fixed w-100">
    ...
    {{--<div>{{$descRankingViews->pluck('view_count')->sum()}} T.Views
  </div>
  ...
  <div class="container mb-5">
    ...
    <div class="row text-center p-1 gx-0 mb-1  shadow-sm  border rounded border-1">
      ...
      <div class="col-7  p-0">
        ...
        {{ucwords(trans(Str::limit($franchise->venue, 24)))}}</a>
      </div> --}}
