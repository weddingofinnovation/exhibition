<main>
    ...
    <style>
        ...
        .handheld-toolbar-item.active .handheld-toolbar-icon i,
        .handheld-toolbar-item.active .handheld-toolbar-label {
            color: red;
            /* or use your primary color */
        }
    </style>
    ...
    <div class="handheld-toolbar">
        <div class="d-table table-layout-fixed w-100">
            ...
            <a class="d-table-cell handheld-toolbar-item {{ request()->route('board') == 'question' ? 'active' : '' }}"
            ...
            <a class="d-table-cell handheld-toolbar-item {{ request()->route('board') == 'selected' ? 'active' : '' }}"
            ...
            <a class="d-table-cell handheld-toolbar-item {{ request()->route('board') == 'add-magazine' ? 'active' : '' }}"
                href="{{ route('admin.questionadd',['eventid' => $this->eventid ,'board' => 'add-magazine']) }}">
