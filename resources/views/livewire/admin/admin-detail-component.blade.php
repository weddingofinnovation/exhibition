  ...
  <div class="row">
    ...
    <div class="col-lg-3">
      ...
      <div class="card mb-2">
        <div class="card-body">
          <h6>Organizer</h6>
          <p>{{ $evento->organizer ?? 'Add organizer' }}</p>
          <a href="{{ route('admin.eventMultiEdit', ['event_id' => $evento->id, 'formm' => 'organiser']) }}" class="btn btn-sm btn-primary">Edit</a>
        </div>
      </div>
      ...
      <div class="card mb-2">
        <div class="card-body">
          <h6>Date</h6>
          <p>{{ Carbon\Carbon::parse($evento->startdate)->format('d M Y') }} - {{ Carbon\Carbon::parse($evento->enddate)->format('d M Y') }}</p>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-6">
      ...
      <div class="card mb-2">
        <div class="card-body">
          ...
          <p>{{ Str::limit($evento->shtdesc, 170) }}</p>
          <a href="{{ route('admin.eventMultiEdit', ['event_id' => $evento->id, 'formm' => 'short']) }}" class="btn btn-sm btn-primary">Edit</a>
        </div>
      </div>
      ...
      <div class="card mb-2">
        <div class="card-body">
          ...
          <p>{{ Str::limit($evento->desc, 170) }}</p>
          <a href="{{ route('admin.eventMultiEdit', ['event_id' => $evento->id, 'formm' => 'desc']) }}" class="btn btn-sm btn-primary">Edit</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-3">
      <div class="card mb-2">
        <div class="card-body">
          ...
          <a href="#" class="btn btn-sm btn-primary">Postpone</a>
          <a href="#" class="btn btn-sm btn-primary">Verify</a>
        </div>
      </div>
    </div>
  </div>
