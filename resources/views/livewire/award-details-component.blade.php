...
@section('page_keyword',  'The Exhibition Network, Exhibition, World largest business event platform, find all upcoming events, business conferences, exhibition 2023, trade shows, global seminars, networking meets and workshops. Browse and connect with visitors attending, participating exhibitors and view profiles of speakers and organizers. Manage, sell event tickets and promote your event on exhbition.org.in')
    ...
    <style>
      .heroo-section {
        background: linear-gradient(to right , #0d0f21, #0b1c2c);
        color: white;
        padding: 80px 20px;
        text-align: left;
        position: relative;
     ...
     <div class="heroo-section">
      <div class="container">
        <h1>Meet our <span class="fw-bold">speakers</span></h1>
        <p>Industry leaders and future-shaping innovators at MWC Barcelona 2025</p>
      </div>
     </div>
        ...
        <div class="row mt-4">
          <div class="col-md-6 col-lg-3">
            <div class="speaker-card">
              <img src="150" alt="speaker-1">
              <h5>Peggy Johnson</h5>
              <p>Agility</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-3">
            <div class="speaker-cardo">
              <img src="150" alt="speaker-1">
              <h5>Ami Badani</h5>
              <p>Arm, Cheif</p>
            </div>
