...
<div class="container py-5 mb-2 mt-n2 mt-sm-1 my-md-3 my-lg-4 mb-xl-5">
        <div class="row justify-content-center">
            <div class="col-lg-11 col-xl-10 col-xxl-9">
                <h1 class="h2 pb-2 pb-sm-3 pb-lg-4">Privacy Policy</h1>
                <hr class="mt-0">
...
<p>This document provides information in relation to the privacy and data protection related practices of ((The Exhibition Network)). It applies to all users of ((The Exhibition Network)). Please ensure that you read the terms of the policy in full before continuing to use our website. Please contact us at the address below in case you have any questions or concerns in relation to any of the below.</p>


<h2 class="h4 pt-3 pt-lg-4">Preliminary</h2>

(" the "Company," "we," "us," and "our,") respect your privacy and are committed to protecting it through our compliance with this privacy policy. This policy describes:
...
<p>Please read this policy carefully to understand our policies and practices regarding your information and how we will treat it. If you do not agree with our policies and practices, you have a choice not to use or discontinue using our Services. By accessing or using our Services, you agree to this privacy policy.
                    </p>

<p>Updates to this Policy: This policy may change from time to time, your continued use of our Services after we make changes is deemed to be acceptance of those changes, so please check the policy periodically for updates.
                    </p>

<p>I. The information we collect and how we use it</p>
...
We also collect contact information if you choose to upload, sync or import it from a device (such as an address book or contact list), which we use for making relevant suggestions such as helping you and others find people you may know or events you might be interested in. This is helpful with IntelliSense which is used to provide you the best possible experience. This information can be used to improve the recommendation for best practices for the user to avail a relevant set of event suggestions and other similar purposes. We do not share or disclose such information and can only be used for suggestions and marketing activities.
...
If you exchange messages with others through the Services, we may store them in order to process and deliver them, allow you to manage them, and investigate possible violations of our Terms of Service and wrongdoing in connection with the Services.
...
To our subsidiaries and affiliates, which are entities under common ownership or control of our ultimate parent company ((The Exhibition Network)).
...
In case you would like to know more about how we keep your information secure, please feel free to reach out to us at help@10times.com with your specific queries.
...
If we become aware that a person submitting personal information is under 16, we will delete the account and all related information as soon as possible. . If you believe we might have any information from or about a child under 16, please contact us at help@10times.com
