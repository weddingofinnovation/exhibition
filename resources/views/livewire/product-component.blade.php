            ...
            <div class="col-md-6 offset-md-3">
              ...
              <div class="mb-4 mb-lg-5 ">
                ...
                <ul class="nav nav-tabs nav-fill" role="tablist">
                  ...
                  <li class="nav-item"><a class="nav-link px-1 fs-sm  {{$currentTab === 'tab4' ? 'active' : ''}}" href="#" wire:click.prevent = "switchTab('tab4')">Exhibit</a></li>
                  <li class="nav-item"><a class="nav-link px-1 fs-sm  {{$currentTab === 'tab5' ? 'active' : ''}}" href="#" wire:click.prevent = "switchTab('tab5')">Advertise</a></li>
