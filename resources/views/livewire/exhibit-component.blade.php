                ...
                <div class="col-md-8">
                  ...
                  <div class="row" style="margin-bottom:20px;">
                    ...
                    <div class="col-md-7 text-right">
                      ...
                      <button class="btn btn-default bg-dark">ASK</button>

                      <button class="btn btn-default bg-dark">Share</button>

                      <button class="btn btn-default bg-dark">Save</button>

                      <button class="btn btn-default bg-dark">⋯</button>
