...
<style>
	...
	@if($productservice == 'great-exhibition-to-exhibit')
				...
				<div class="container pt-4 pt-sm-5">
					<div class="row g-xl-5">
						...
						<div class="col-xl-7 mb-5 mb-xl-0">
							<div class="pe-xxl-4">
								<span class="heading-color d-inline-block bg-light small rounded-3 px-3 py-2">🤩 Award-winning Exhibition</span>

								<!-- Title -->
								<h1 class="mt-3 lh-base">Find audience foucs oppportunity with 
									<span class="cd-headline clip big-clip is-full-width text-primary mb-0 d-block d-xxl-inline-block">
										<span class="typed" data-type-text="Web Design Web Dev UI/UX Design">Exibition Navigator</span><span class="ityped-cursor"></span>
									</span>
								</h1>
						...
						<div class="col">
							<div class="card bg-light h-100">
								<div class="card-body pb-0">
									...
									<!-- Content -->
									<h5 class="mb-3 "><a  class="text-coloro" href="#">Tracking Business Goals & Audience</a></h5>
									<p>The Exhibition Navigator helps companies track their specific business goals and target audience for each event they plan to participate in.</p>
								</div>
						...
						<div class="col">
							<div class="card bg-light h-100">
								<div class="card-body pb-0">
									...
									<!-- Content -->
									<h5 class="mb-3"><a href="#" class="text-coloro">Event Tracking</a></h5>
									<p >tracks a wide range of events, including regional exhibitions, occasional events, and trending market opportunities, allowing companies to stay updated on relevant industry haappenings.</p>
								</div>
								<div class="card-footer bg-light mt-auto pt-2">
									<a class="icon-link icon-link-hover" href="#">Know more<i class="bi bi-arrow-right"></i> </a>
								</div>
						...
						<div class="col">
							<div class="card bg-light h-100">
								<div class="card-body pb-0">
									...
									<!-- Content -->
									<h5 class="mb-3"><a href="#" class="text-coloro" >Deal Negotiation</a></h5>
									<p>The tools assists in finding and negotiating deals with event organizers, ensuring that companies secure favorable terms for thier participation.</p>
								</div>
								<div class="card-footer bg-light mt-auto pt-2">
									<a class="icon-link icon-link-hover" href="#">Know more<i class="bi bi-arrow-right"></i> </a>
								</div>
						...
						<div class="col">
							<div class="card bg-light h-100">
								<div class="card-body pb-0">
									...
									<!-- Content -->
									<h5 class="mb-3"><a class="text-coloro" href="#">Effective Marketing Strategies</a></h5>
									<p >the Exhibition Navigator provides insights and tools for creating and implementing effective marketing strategies tailored to each event maximizing visibility and engagement.</p>
								</div>
								<div class="card-footer bg-light mt-auto pt-2">
									<a class="icon-link icon-link-hover" href="#">Know more<i class="bi bi-arrow-right"></i> </a>
								</div>
						...
						<div class="col">
							<div class="card bg-light h-100">
								<div class="card-body pb-0">
									...
									<!-- Content -->
									<h5 class="mb-3"><a href="#" class="text-coloro">Booking & Execution </a></h5>
									<p >It facilitates the booking of exhibition space and handles all aspects of event execution, including fabrication of booths or displays.</p>
								</div>
								<div class="card-footer bg-light mt-auto pt-2">
									<a class="icon-link icon-link-hover" href="#">Know more<i class="bi bi-arrow-right"></i> </a>
								</div>
						...
						<div class="col">
							<div class="card bg-light h-100">
								<div class="card-body pb-0">
									...
									<!-- Content -->
									<h5 class="mb-3"><a href="#" class="text-coloro">Marketing Templates and Call-To-Actions </a></h5>
									<p> It offers pre-designed marketing templates that companies can use for promotional materials, along with tools for creating compelling call-to-action messages to drive attendee engagement.</p>
								</div>
								<div class="card-footer bg-light mt-auto pt-2">
									<a class="icon-link icon-link-hover" href="#">Know more<i class="bi bi-arrow-right"></i> </a>
								</div>
						...
						<div class="col">
							<div class="card bg-light h-100">
								<div class="card-body pb-0">
									...
									<!-- Content -->
									<h5 class="mb-3"><a href="#" class="text-coloro">Email Campaigns</a></h5>
									<p>The tool supports email marketing campaigns, allowing companies to reach out to their target audience before, during, and after the event.</p>
								</div>
								<div class="card-footer bg-light mt-auto pt-2">
									<a class="icon-link icon-link-hover" href="#">Know more<i class="bi bi-arrow-right"></i> </a>
								</div>
						...
						<div class="col">
							<div class="card bg-light h-100">
								<div class="card-body pb-0">
									...
									<!-- Content -->
									<h5 class="mb-3"><a href="#" class="text-coloro">Pre-Post-During Event Activities</a></h5>
									<p >It manages all activities related to the event, from pre-event promotions to post event follow ups, ensuring a seamless and effective experience for exhibitors.</p>
								</div>
								<div class="card-footer bg-light mt-auto pt-2">
									<a class="icon-link icon-link-hover" href="#">Know more<i class="bi bi-arrow-right"></i> </a>
								</div>
					...
					<div class="container">
						...
						<div class="row g-4">
							...
							<div class="col-md-8 col-lg-9">
								<div class="row g-4 filter-container" data-isotope-collection data-isotope='{ "itemSelector": ".grid-item", "layoutMode": "fitRows" }' style="position: relative; height: 1833.76px;">
									<!-- Work item -->
...
<section class="container py-5 mt-2 mb-3 my-sm-3 my-md-4 my-lg-5">
        ...
        <div class="row align-items-center justify-content-center pb-xl-4 mb-xxl-2">
          ...
          <div class="col-sm-9 col-md-6 col-lg-5 offset-lg-1 order-md-1">
            <ul class="list-unstyled gap-3 mb-0">
              <li class="d-flex">
                <svg class="text-primary mt-2 me-3" xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10" fill="none"><circle cx="5" cy="5" r="4.125" stroke="currentColor" stroke-width="1.75"></circle></svg>
        ...
        <div class="position-relative flex-xxl-shrink-0 z-2 start-50 translate-middle-x my-n2" style="max-width: 1920px;">
          <div class="mx-n2 mx-sm-n5 mx-xxl-0">
            <div class="mx-lg-n5 mx-xxl-0">
              <img-comparison-slider class="focus-none text-primary mx-n5 mx-xxl-0 rendered" style="--divider-width: .125rem; --divider-color: currentColor" tabindex="0">
      ...
      <section class="container mb-4">
        ...
        </div></div></div></div><div class="simplebar-placeholder" style="width: 1250px; height: 112px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar simplebar-visible" style="width: 0px; display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: hidden;"><div class="simplebar-scrollbar simplebar-visible" style="height: 0px; display: none;"></div></div></div>
      </section>
					...
					<div class="row g-xl-5">
						...
						<div class="col-xl-7 mb-5 mb-xl-0">
							<div class="pe-xxl-4">
								...
								<p class="mb-0 mt-4 mt-md-5">From concept to execution, we deliver business events as right place that make an impact. Let your brand shine with our innovative and visually stunning places with right audience.</p>
