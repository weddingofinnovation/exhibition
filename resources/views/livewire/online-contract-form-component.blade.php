			...
			<div class="container pt-4 pt-sm-5">
				<div class="row g-xl-5">
					...
					<div class="col-md-10 col-xl-5 position-relative mx-auto mt-7 mt-xl-0">
						...
						<!-- Hero image -->
						<img src="{{asset('public/image/04.jpg')}}" class="rounded" alt="04hero-img">
		...
		<section class=" sectionlevel pb-0" data-bs-theme="light">
			<div class="container">
				...
				<div class="inner-container text-center mb-4 mb-sm-6">
					<span class="heading-color bg-light small rounded-3 px-3 py-2" style="font-weight: 400;">💵 Transparent pricing packages</span>
