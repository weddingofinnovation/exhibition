						...
						<div class="card card-body bg-transparent h-100 px-0">
							<div class="row text-center text-sm-start">
								...
								<div class="col-sm-6 ps-md-5">
									<h6 class="mb-sm-4 textcolor">Features list of your need</h6>
									<!-- List -->
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-6 mb-5 mb-lg-0">
						...
						<!-- Title -->
						<h2 class="my-4 textcolor">See how we've helped our clients succeed</h2>

						<h6 class="mb-0 textcolor">More than 1500+ agencies using Mizzle</h6>
