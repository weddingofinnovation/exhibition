...
<div class="d-lg-none">
    ...
    <div class="container text-center border-1 bg-secondary py-2">
        ...
        <div class="scroll-container">
            ...
            <div class="scroll-content">
                @foreach($photos as $image)
                    <img src="{{url('public/assets/image/exhibition/'.$image->brand_logo)}}" alt="Brand Logo">
                @endforeach
                <!-- Duplicating content for seamless scroll -->
                @foreach($photos as $image)
                    <img src="{{url('public/assets/image/exhibition/'.$image->brand_logo)}}" alt="Brand Logo">
                @endforeach
            </div>
